  ...
  return (
    <ShaderBackground>
      <div className="absolute inset-0 flex flex-col items-start justify-center px-4 md:px-8 pt-20 pb-24 z-10">
        <div className="rounded-2xl frosted-glass-mobile md:bg-white/70 md:backdrop-blur-md px-8 py-10 md:px-12 md:py-12 shadow-[0_0_40px_rgba(255,255,255,0.6)] max-w-xl text-left">
